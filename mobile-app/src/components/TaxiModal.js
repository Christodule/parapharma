...
export default function TaxiModal(props) {
    ...
    const { settings, tripdata, estimate, bookingModalStatus, onPressCancel, bookNow, payment_mode, setPaymentMode, radioProps } = props;
        ...
        <View>
            ...
            >
                <View style={styles.container}>
                    ...
                    <View style={{width:width, justifyContent:'center', alignItems:'center', borderTopColor: colors.BOX_BG, borderTopWidth: 1}}>
                        <Text style={[styles.offerText,{paddingTop:10, paddingBottom: 10}]}>{t('payment_mode')}</Text>
                    </View>
                    <View style={{width:width, paddingBottom:8, justifyContent:'center', alignItems:'center', borderBottomColor: colors.BOX_BG, borderBottomWidth: 1}}>
                        <RadioForm
...
const styles = StyleSheet.create({
    ...
    offerContainer: { flex: 1, backgroundColor: colors.BOX_BG, width: width, justifyContent: 'center', borderBottomColor: colors.BOX_BG, borderBottomWidth: Platform.OS == 'ios' ? 1 : 0 },
