...
import { carTypeColumns, isParcelRequired, isOptionsRequired } from 'common/sharedFunctions';
                ...
                new Promise((resolve) => {
                  setTimeout(() => {
                    ...
                    if(newData !== oldData){
                      ...
                      delete tblData[rowIndex][modalType][tblData[rowIndex][modalType].indexOf(newData)].tableData;
                      dispatch(editCarType(tblData[rowIndex]), "Update");
                    }
                  }, 600);
                })
